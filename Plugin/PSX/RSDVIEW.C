// local dload bow.pck  0x80090000
// pck file must be loaded at that address!
...
#define OBJECTMAX 10		/* Max Objects */
...
obj_interactive()
{
	...
	FntPrint(0, "       POS    LIGHT\n");
	FntPrint(0, "X = %06d %06d\n", DWorld.coord.t[0], pslt[2].vx);
	FntPrint(0, "Y = %06d %06d\n", DWorld.coord.t[1], pslt[2].vy);
	FntPrint(0, "Z = %06d %06d\n", DWorld.coord.t[2], pslt[2].vz);
	...
	if (level == 0)
		FntPrint(0,"SCREEN SCALE is NORMAL");
	else
		FntPrint(0,"SCREEN SCALE is 1/8");
